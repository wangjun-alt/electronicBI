...
from apps.contracts.views import SetContractDataView, GetContractNumView, SearchContractView, GetTableDataView,UploadContractView, GetContractView
...
urlpatterns = [
    ...
    path('getfiled/', GetContractView.as_view())
]